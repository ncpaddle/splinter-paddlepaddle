...
class QuestionAwareSpanSelectionHead(Module):
    def __init__(self, hidden_size=768):
        ...
        self.start_classifier = Parameter(torch.Tensor(hidden_size, hidden_size))
        self.end_classifier = Parameter(torch.Tensor(hidden_size, hidden_size))
...
class ModelWithQASSHead(BertPreTrainedModel):
    def __init__(self, replace_mask_with_question_token=False,
